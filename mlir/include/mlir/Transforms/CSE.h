...
public:
  ...
  virtual unsigned getHashValue(Operation *op) const = 0;

  /// Returns true if two operations are equivalent.
  virtual bool isEqual(Operation *lhs, Operation *rhs) const = 0;
